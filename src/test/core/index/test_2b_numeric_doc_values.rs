...
struct Test2BNumericDocValues;

// Indexes IndexWriter::MAX_DOCS documents with an increasing doc-values field.
#[cfg(feature = "monster")]
#[test]
#[ignore = "monster"]
fn test_numerics() -> Result<()> {
  ...
  for i in 0..MAX_DOCS {
    let Some(Fields::NumericDocValues(field)) = doc.get_field_mut("dv") else {
